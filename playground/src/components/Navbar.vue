...
<template>
  <nav class="flex items-center justify-between flex-wrap p-3" style="background: #ec0016">
    <div class="flex items-center flex-shrink-0 text-white mr-6 ml-4">
      <div class="leading-none">
        <span class="font-semibold text-lg tracking-tight">Vue Class Style Codemod</span>
        <br />
